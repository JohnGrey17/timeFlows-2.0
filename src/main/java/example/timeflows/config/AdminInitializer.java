...
public class AdminInitializer implements CommandLineRunner {
    ...
    public AdminInitializer(
            ...
            BonusCategoryRepository bonusCategoryRepository) {
    ...
    public void run(String... args) {
        ...
        createDemoBonus(
                petro, architectManager, new BigDecimal("400.00"), "За архітектурну ініціативу");
    }
    ...
    private void assignManager(Division division, User manager) {
        if (division.getManager() == null
                || !division.getManager().getId().equals(manager.getId())) {
    ...
    private void createDemoBonus(User user, User creator, BigDecimal amount, String description) {
        boolean exists =
                bonusRepository
                        ...
                        .stream()
                        .anyMatch(b -> b.getDescription().equals(description));
        if (!exists) {
            ...
            bonus.setCategory(bonusCategoryRepository.findAllByOrderByNameAsc().get(0));
